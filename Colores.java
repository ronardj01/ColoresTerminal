public class Colores {
   ...
   /*Los colores de texto son código \033[3Xm y \033[9Xm la X va del 1 al 7
      ...
      *** Es posible convinar negrita, texto y fondo el orden es importante \033[1;3X;4Xm 
        ...
        *** Esto fuciona para Linux y Mac para windows lo ideal es usar una libreria como "JANSI"
        para saber en que sistema operativo se esta ejecutando java podemos usar 
        System.getProperty("os.name") y System.getProperty("os.arch")
    */
